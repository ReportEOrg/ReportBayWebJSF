package org.reportbay.web.util;
...
import org.reportbay.web.common.LegendPositionEnum;
import org.reportbay.web.common.PieChartDataFormatEnum;
import org.reportbay.web.dto.reportgen.CartesianChartReport;
import org.reportbay.web.dto.reportgen.ChartReport;
import org.reportbay.web.dto.reportgen.PieChartReport;
...
public class ReportUtil{
	...
	/**
	 * mapping cartesian chart report to primeFace LineChartModel
	 * @param report
	 * @return
	 */
	public static LineChartModel mapAreaReportToPFModel(CartesianChartReport report){

		return mapAreaReportToPFModel(report, -60);
	}
	 ...
	 * @return
	 */
	public static LineChartModel mapAreaReportToPFModel(CartesianChartReport report, int xAxisLabelTickAngle){
	...
	/**
	 * mapping cartesian chart report to primeFace BarChartModel
	 * @param report
	 * @return
	 */
	public static BarChartModel mapBarReportToPFModel(CartesianChartReport report){
	...
	/**
	 * mapping cartesian chart report to primeFace HorizontalBarChartModel
	 * @param report
	 * @return
	 */
	public static HorizontalBarChartModel mapColumnReportToPFModel(CartesianChartReport report){
	 ...
	 * @return
	 */
	public static LineChartModel mapLineReportToPFModel(CartesianChartReport report){
		LineChartModel model = new LineChartModel();
	 ...
	 * @return
	 */
	public static PieChartModel mapPieReportToPFModel(PieChartReport report){
	...
	private static void updatePieChart(PieChartModel model, PieChartReport report){
		...
		PieChartDataFormatEnum dataTypeFormat = report.getDataTypeFormat();
		
		if(dataTypeFormat!=null){
			model.setDataFormat(dataTypeFormat.getCode());
		}
	}
	...
	private static void updateCommonLineSeries(CartesianChartModel model, CartesianChartReport report, boolean fill){
		...
		for(org.reportbay.web.dto.reportgen.ChartSeries reportSeries: report.getChartDataSeries()){
